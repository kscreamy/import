...
class ProductMapper
{
    ...
    public function mapToProduct(array $entry)
    {
        ...
        if ($this->productMapping->brandPath && $accessor->isReadable($entry, $this->productMapping->brandPath)) {
            $product->setBrand($accessor->getValue($entry, $this->productMapping->brandPath));
        }
